<?php
    ...
    if(sizeof($selectedRow) > 0)
    {
        ...
        $sql = "INSERT INTO DEMO_JUMMUM_OM.`forgotpassword`(`CodeReset`, `Email`, `RequestDate`, `Status`, `DbName`, `ModifiedUser`, `ModifiedDate`) VALUES ('$codeReset','$username','$requestDate','1','$dbName','$modifiedUser',now())";
        $ret = doQueryTask($sql);
        if($ret != "")
        {
            mysqli_rollback($con);
        ...
        sendEmail($username,"Reset password from DEMO JUMMUM DEMO_JUMMUM_OM",$emailBody);
    }
