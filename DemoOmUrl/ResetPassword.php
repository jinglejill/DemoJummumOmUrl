...
<p>&nbsp;<img class="" src="http://www.jummum.co/DEMO_JUMMUM_OM/jummumOMLogo.png" alt="" width="120" /></p>
...
<p style="font-size:16px;">**หากคุณต้องการความช่วยเหลือสามารถติดต่อผ่านทางอีเมลล์&nbsp;<a href="mailto:help@jummum.co">help@jummum.co</a>&nbsp;หรือโทร 081-307-2993</p>
</form>
<table width="100%">
<tbody>
<tr>
...
<?php
    ...
    if($_POST["submit"])
    {
        ...
        else
        {
            ...
            {
                header("Location: http://www.jummum.co/DEMO_JUMMUM_OM/ResetPasswordTimeOut.php");
            ...
            else
            {
                ...
                $sql = "update $dbName.useraccount set password = '$hashPassword', modifiedDate = now() where username = '$email'";
                $ret = doQueryTask($sql);
                if($ret != "")
                {
                    mysqli_rollback($con);
